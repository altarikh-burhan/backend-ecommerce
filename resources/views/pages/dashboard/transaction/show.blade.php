<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <a class="inline-block border border-blue-700 bg-blue-700 text-white rounded-md px-2 py-1 m-2 transition duration-500 ease select-none hover:bg-blue-800 focus:outline-none focus:shadow-outline" 
            ...
            <div class="bg-white overflow-hidden shadow sm:rounded-lg mb-10">
                <div class="p-6 bg-white border-b border gray-800">
                    <table class="table-auto w-full">
                        <tbody>
                            <tr>
                                <th class="border px-6 px-4 text-right">Name</th>
                                <td class="border px-6 py-4">{{ $transaction }}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <th class="border px-6 px-4 text-right">Address</th>
                                <td class="border px-6 py-4">{{ $transaction->address }}</td>
                            </tr>
                            <tr>
                                <th class="border px-6 px-4 text-right">Payment</th>
                                <td class="border px-6 py-4">{{ $transaction->payment }}</td>
                            </tr>
                            <tr>
                                <th class="border px-6 px-4 text-right">Total Price</th>
                                <td class="border px-6 py-4">{{ number_format($transaction->total_price) }}</td>
                            </tr>
                            <tr>
                                <th class="border px-6 px-4 text-right">Shipping Price</th>
